...
var LocalSdk = function LocalSdk(host, timeoutInt) {
  ...
  this.sendReq = function (url, callback, data) {
    ...
    return new Promise(function (resolve, reject) {
      ...
      fetch(ref.BASE + url, extra).then(function (response) {
  ...
  this.configure = function (data, callback) {
    if (typeof data.mqtt !== 'undefined' && typeof data.mqtt.ip !== 'undefined') {
      ...
      var retData = { error: 1, msg: 'Required parameters are missing.' };
      callback(retData);
    }
  };

  this.setStandby = function (data, callback) {
    if (typeof data.standby !== 'undefined') this.sendReq('setStandby', callback, data);else {
      var retData = { error: 1, msg: 'Required parameter is missing.' };
      callback(retData);
    }
  };

  this.setHorizontalAirFlowDirection = function (data, callback) {
    if (typeof data.horizontalAirFlowDirection !== 'undefined') this.sendReq('setHorizontalAirFlowDirection', callback, data);else {
      var retData = { error: 1, msg: 'Required parameter is missing.' };
      callback(retData);
    }
  };
  ...
  this.setVerticalAirFlowDirection = function (data, callback) {
    if (typeof data.verticalAirFlowDirection !== 'undefined') this.sendReq('setVerticalAirFlowDirection', callback, data);else {
      var retData = { error: 1, msg: 'Required parameter is missing.' };
      callback(retData);
    }
  };
  ...
  this.setThermostatSetpoint = function (data, callback) {
    if (typeof data.thermostatSetpoint !== 'undefined') this.sendReq('setThermostatSetpoint', callback, data);else {
      var retData = { error: 1, msg: 'Required parameter is missing.' };
      callback(retData);
    }
  };
  ...
  this.setThermostatMode = function (data, callback) {
    if (typeof data.thermostatMode !== 'undefined' && typeof data.thermostatFanMode !== 'undefined' && typeof data.thermostatSetpoint !== 'undefined') {
  ...
  this.refresh = function (data, callback) {
    if (typeof data !== 'undefined') this.sendReq('refresh', callback, data);else this.sendReq('refresh', callback);
  };

  this.getStatus = function (data, callback) {
    if (typeof data !== 'undefined' && Object.keys(data).length > 0) this.sendReq('getStatus', callback, data);else {
      var retData = { error: 1, msg: 'Required parameter is missing.' };
      callback(retData);
    }
  };
