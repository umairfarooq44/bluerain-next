...
// import CurrentChartStateful from './CurrentChart.stateful';
import CurrentChartContainer from './CurrentChart.container';
  ...
  options: (args) => {
    ...
    const queryString = {
      where: {
        ...
        time: { between: [startDateFormatted, endDateFormatted] },
        "or":[{'data.standby': { exists: true }}, {'data.current': { exists: true }}]
      },
      order: 'time DESC'
    };
