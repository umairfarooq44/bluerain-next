...
import BillReportIndex from './index';
...
export default class BillReportWidget extends React.Component {
  ...
  render() {
    ...
    const startDateFormatted = moment(startDate).toISOString();
    const endDateFormatted = moment(endDate).toISOString();
...
BillReportWidget.propTypes = propTypes;
BillReportWidget.defaultProps = defaultProps;
