...
var _TimeChart = require('./TimeChart.component');
...
var sum = void 0;
var sumInMints = void 0;
var sumInHours = void 0;
var diff = void 0;

var TimeChartContainer = function (_React$Component) {
  _inherits(TimeChartContainer, _React$Component);

  function TimeChartContainer() {
    _classCallCheck(this, TimeChartContainer);

    return _possibleConstructorReturn(this, (TimeChartContainer.__proto__ || Object.getPrototypeOf(TimeChartContainer)).apply(this, arguments));
  }

  _createClass(TimeChartContainer, [{
    key: 'render',
    value: function render() {
      ...
      try {
        ...
        if (dataFromQuery.length === 0) {
          ...
          dataFromQuery.forEach(function (item, i) {
      ...
      // lastReading = roundedValue;
      if (showGraph) {
        return _react2.default.createElement(_TimeChart2.default, _extends({
          data: data,
          x: 'time',
          y: function y(datum) {
            return datum.standby;
          },
    ...
    key: 'renderTimeDiff',
    value: function renderTimeDiff(data, i) {
      diffArr = [];
      data.reverse(); // to get data in descending order
      for (i = 1; i < data.length; i++) {
        prevStatus = data[i - 1].data.standby; // get previous value of standby
        if (prevStatus === false) {
          // only get values for standby false as previous value
          var time1 = (0, _moment2.default)(new Date(data[i].time));
          var time2 = (0, _moment2.default)(new Date(data[i - 1].time));
      ...
      sum = diffArr.reduce(function (a, b) {
        return a + b;
...
exports.default = TimeChartContainer;
