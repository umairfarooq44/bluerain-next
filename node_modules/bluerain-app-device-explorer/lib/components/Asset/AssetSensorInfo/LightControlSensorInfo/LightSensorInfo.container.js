...
var LightSensorInfo = function (_React$Component) {
  _inherits(LightSensorInfo, _React$Component);

  function LightSensorInfo() {
    _classCallCheck(this, LightSensorInfo);

    return _possibleConstructorReturn(this, (LightSensorInfo.__proto__ || Object.getPrototypeOf(LightSensorInfo)).apply(this, arguments));
  }

  _createClass(LightSensorInfo, [{
    key: 'render',
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        LightSensorInfo.renderConnectionStatus(connected)
      );
    }
  }], [{
...
exports.default = LightSensorInfo;


LightSensorInfo.propTypes = propTypes;
LightSensorInfo.defaultProps = defaultProps;