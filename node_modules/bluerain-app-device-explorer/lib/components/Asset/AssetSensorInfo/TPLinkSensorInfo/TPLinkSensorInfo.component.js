...
var TPLinkSensorInfo = function (_React$Component) {
  _inherits(TPLinkSensorInfo, _React$Component);

  function TPLinkSensorInfo() {
    _classCallCheck(this, TPLinkSensorInfo);

    return _possibleConstructorReturn(this, (TPLinkSensorInfo.__proto__ || Object.getPrototypeOf(TPLinkSensorInfo)).apply(this, arguments));
  }

  _createClass(TPLinkSensorInfo, [{
    key: 'render',
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        TPLinkSensorInfo.renderConnectionStatus(connected)
      );
    }
  }], [{
  ...
  return TPLinkSensorInfo;
}(_react2.default.Component);

exports.default = TPLinkSensorInfo;


TPLinkSensorInfo.propTypes = propTypes;
TPLinkSensorInfo.defaultProps = defaultProps;