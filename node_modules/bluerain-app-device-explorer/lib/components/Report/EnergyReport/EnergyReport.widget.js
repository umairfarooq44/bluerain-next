...
var CurrentReportWidget = function (_React$Component) {
  _inherits(CurrentReportWidget, _React$Component);

  function CurrentReportWidget(props) {
    _classCallCheck(this, CurrentReportWidget);

    var _this = _possibleConstructorReturn(this, (CurrentReportWidget.__proto__ || Object.getPrototypeOf(CurrentReportWidget)).call(this, props));
  ...
  _createClass(CurrentReportWidget, [{
    key: 'onDatesChange',
  ...
  return CurrentReportWidget;
}(_react2.default.Component);

exports.default = CurrentReportWidget;
