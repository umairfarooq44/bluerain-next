...
var PowerReportWidget = function (_React$Component) {
  _inherits(PowerReportWidget, _React$Component);

  function PowerReportWidget(props) {
    _classCallCheck(this, PowerReportWidget);

    var _this = _possibleConstructorReturn(this, (PowerReportWidget.__proto__ || Object.getPrototypeOf(PowerReportWidget)).call(this, props));
  ...
  _createClass(PowerReportWidget, [{
    key: 'onDatesChange',
  ...
  return PowerReportWidget;
}(_react2.default.Component);

exports.default = PowerReportWidget;


PowerReportWidget.propTypes = propTypes;
PowerReportWidget.defaultProps = defaultProps;