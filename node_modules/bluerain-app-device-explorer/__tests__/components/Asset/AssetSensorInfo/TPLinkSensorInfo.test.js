...
import TPLinkSensorInfo from '../../../../src/components/Asset/AssetSensorInfo/TPLinkSensorInfo/TPLinkSensorInfo.container';

describe('TPLinkSensorInfo Component Test Specifications', () => {
  ...
  it('should check proptype of data', () => {
    ...
    const cardWrapper = <TPLinkSensorInfo data={sensorInfoData} />;
  ...
  it('should render successfully when params are passed', () => {
    ...
    ReactDOM.render(<TPLinkSensorInfo data={sensorInfoData} />, div);
  ...
  it('element with list-group-item should not exist when connected prop is not passed.', () => {
    ...
    const component = TestUtils.renderIntoDocument( <TPLinkSensorInfo data={sensorInfoData} /> );
...
it('li element count should be equal to 1', () => {
  ...
  const cardWrapper = shallow(<TPLinkSensorInfo data={sensorInfoData} />);
