...
import BarChartAxis from './BarChartAxis.component';

const stories = storiesOf('BarChartAxis', module);
stories.addDecorator(withKnobs);
const style = {
  width: 300
};

stories.addWithInfo('BarChartAxis with tooltip', () => {
  const fillColor = text('fillcolor', 'blue');
...
stories.addWithInfo('BarChartAxis without tooltip', () => {
  const fillColor = text('fillcolor', 'blue');
  const strokeColor = text('fillcolor', 'red');
  const measurementData = [
    {
