...
var PostCardItem = function (_React$Component) {
  _inherits(PostCardItem, _React$Component);

  function PostCardItem(props) {
    _classCallCheck(this, PostCardItem);

    var _this = _possibleConstructorReturn(this, (PostCardItem.__proto__ || Object.getPrototypeOf(PostCardItem)).call(this, props));

    _this.handleClickAction = _this.handleClickAction.bind(_this);
    return _this;
  }

  _createClass(PostCardItem, [{
