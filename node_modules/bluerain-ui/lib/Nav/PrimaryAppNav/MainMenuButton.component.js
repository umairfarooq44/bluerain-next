...
var MainMenuButton = function (_React$Component) {
  _inherits(MainMenuButton, _React$Component);

  function MainMenuButton(props) {
    _classCallCheck(this, MainMenuButton);

    var _this = _possibleConstructorReturn(this, (MainMenuButton.__proto__ || Object.getPrototypeOf(MainMenuButton)).call(this, props));
  ...
  _createClass(MainMenuButton, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'button',
        { onClick: this.handleClickAction, style: style },
        _react2.default.createElement(_reactFa2.default, { name: 'bars' })
      );
    }
  }]);
