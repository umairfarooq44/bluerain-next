...
var _BarChart = require('./BarChart.component');
...
var stories = (0, _storybook.storiesOf)('BarChart', module);
stories.addDecorator(_storybookAddonKnobs.withKnobs);
var style = {
  width: 300
};

stories.addWithInfo('BarChart with tooltip', function () {
  var fillColor = (0, _storybookAddonKnobs.text)('fillcolor', 'blue');
  var strokeColor = (0, _storybookAddonKnobs.text)('fillcolor', 'red');
  var tooltip = true;
  var measurementData = [{
  ...
  var data = (0, _storybookAddonKnobs.array)('data', measurementData);
...
stories.addWithInfo('BarChart without tooltip', function () {
  var fillColor = (0, _storybookAddonKnobs.text)('fillcolor', 'blue');
  var strokeColor = (0, _storybookAddonKnobs.text)('fillcolor', 'red');
  var measurementData = [{
